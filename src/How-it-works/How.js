            ...
            <div className={classes.blocks}>
                <div className={classes.card}>
                        ...
                        <div  className={classes.text}>
                            <h2>Search</h2>
                            <p>Search through our list of properties for rent shared  by other people </p>
                        </div>
                </div>
                <div  className={classes.card}>
                        <div className={classes.image2}>
                        ...
                        <div  className={classes.text}>
                            <h2>Post</h2>
                            <p>Snap and share photos of your properties available for rent and lease</p>
                        </div>
                </div>
                <div  className={classes.card}>
                        ...
                        <div  className={classes.text1}>
                            <h2>Connect</h2>
                            <p>Connect with preferred house owner and make an offer offline</p>
                        </div>
                </div>
            </div>
      </div>
